...
### Added
- Formal specification (SPEC.md v1.0.0-draft, 935 lines)
- ANTLR4 grammar (UEAS.g4) with Modern Mathematical syntax
- AST node types (30 kinds), Factory, Visitor, JSON serde
...
- Exit codes (0-11) per Section 6.5
...
- 10 composite builtins: union, intersection, difference, get, put, containsKey, keys, values, transpose, prepend/slice
- Dynamic step costing for builtin operations
...
- 7 benchmark example .ueas files
